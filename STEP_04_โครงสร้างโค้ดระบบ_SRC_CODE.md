# 💻 STEP 04: ซอร์สโค้ดระบบจัดการสินค้า (Source Code Implementation)

เอกสารฉบับนี้อธิบายโค้ดระบบจัดการสินค้าคงคลัง ที่พัฒนาขึ้นตามข้อกำหนดใหม่ (ประกาศวันที่ 11 ก.ย.) รองรับสินค้า 2 ประเภท:
1. **PhysicalProduct**: ตัดสต็อกจริงเมื่อสั่งซื้อ และมีเงื่อนไขห้ามขายเกินสต็อก
2. **DigitalProduct**: ขายได้ไม่จำกัดจำนวน ไม่ตัดสต็อก และควบคุมสิทธิ์การดาวน์โหลดไฟล์เมื่อชำระเงินเสร็จสิ้น

---

## ซอร์สโค้ด src/inventory.py
```python
